...
REQUEST_BODY='{ "login": "'$USERNAME'", "nonce": "'$(uuidgen 2>/dev/null | sha256sum | cut -c1-32)'", "read_only": false, "expiration_time": "1 minute", "label": "AutoGenerated by '$HOSTNAME'", "global_key": false }'
