...
License:        MIT
URL:            https://github.com/Byron/%{name}
Source0:        https://github.com/Byron/%{name}/archive/refs/tags/v%{version}.tar.gz
...
cargo build --release --verbose --locked  --no-default-features --features tui-crossplatform
