...
Source0:        https://github.com/achristmascarl/%{name}/archive/refs/tags/v%{version}.tar.gz
...
cargo build --release --verbose --locked --no-default-features --features musl
...
%changelog
* Thu Nov 13 2025 Ante de Baas <antedebaas@users.github.com> - 0.3.10-1
- initial package
